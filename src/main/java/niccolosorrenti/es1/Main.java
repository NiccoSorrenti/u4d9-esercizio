...
public class Main {
    public static void main(String[] args) {
        ...
        Map<Customer, List<Order>> listaOrdini = orders.stream().collect(Collectors.groupingBy(order -> order.getCustomer()));
        listaOrdini.forEach((cliente, ordini) -> System.out.println("Cliente: " + cliente + " Ordine: " + ordini));
